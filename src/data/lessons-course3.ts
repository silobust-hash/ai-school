...
export const lessonsCourse3: Record<string, Lesson> = {
  ...
  "3-3": {
    ...
    sections: [
      {
        heading: "Git이란? — 문서와 코드의 변경 이력 관리",
        content:
  ...
  "3-5": {
    ...
    insights: [
      {
        heading: "건축가는 벽돌을 직접 쌓지 않는다",
        content:
          "바이브코딩은 코드를 한 줄도 안 쓰고 AI에게 '이거 만들어줘'라고 말로 설명해서 프로그램을 만드는 겁니다. 건축가가 벽돌을 직접 안 쌓고 설계도를 그리는 것과 같죠. 전통 코딩이 직접 요리라면, 바이브코딩은 셰프에게 '매콤하고 든든한 거 해주세요'라고 주문하는 것입니다.",
        source: "바이브코딩 완전정복 (2026)",
      },
      {
        heading: "한꺼번에 다 만들지 말고 단계로 쪼개라",
        content:
          "바이브코딩 성공의 핵심은 단계별 진행입니다. '모든 기능 다 만들어줘'가 아니라 1단계 기본 계산, 2단계 디자인, 3단계 데이터 저장, 4단계 인쇄 순으로 가야 합니다. 그리고 AI가 만든 결과물은 반드시 직접 확인하고 '이 부분 이상한데?' 하고 고쳐가며 완성도를 높이는 게 정석입니다.",
        source: "바이브코딩 완전정복 (2026)",
      },
    ],
    keyTakeaways: [
