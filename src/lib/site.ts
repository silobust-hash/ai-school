...
export const PERSON_SILROPANDA_URL = "https://silropanda.com/";
export const PERSON_SILROPANDA_LABEL = "실로판다 전문서비스몰";
export const PERSON_SILROPANDA_PURPOSE = "박실로 노무사의 시간·판단·강의 의뢰, AEO·GEO 강의 포함";
